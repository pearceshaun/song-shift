...
- [ ] **2.1** Create `song_shift/config.py` — CredentialStore class per spec. Write `tests/test_config.py` with all 6 test cases from spec (use tmp_path fixture for isolation). Run `uv run pytest tests/test_config.py` — all pass.
